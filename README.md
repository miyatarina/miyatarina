...
- 所属:愛媛大学大学院 理工学研究科 理工学専攻 数理情報プログラム 自然言語処理研究室 D1
...
- 国際会議
  - Rina Miyata, Koki Horiguchi, Risa Kondo, Yuki Fujiwara and Tomoyuki Kajiwara. <dr>
    ...
    In proceedings of the Fourth Workshop on Text Simplification, Accessibility and Readability (TSAR 2025), pp.217–222, Suzhou, China, November, 2025. \[[PDF](https://aclanthology.org/2025.tsar-1.18/)\]
...
- 国内会議
  - 宮田莉奈, 梶原智之. <br>
    大規模言語モデルにおける難易度推定から難易度制御への知識転移. <br>
  ...
  - 宮田莉奈, 梶原智之. <br>
    テキスト平易化のための難易度に基づく検索拡張生成. <br>
    言語処理学会第32回年次大会 (NLP), March 2026.

  - 花房健太郎, 宮田莉奈, 梶原智之, 北岡佑一, 荒木亮, 真嘉比愛 <br>
    大規模言語モデルによる日本語文法誤り訂正の性能評価. <br>
    言語処理学会第32回年次大会 (NLP), March 2026.

  - 宮田莉奈, 梶原智之. <br>
    大規模言語モデルによる英文難易度の推定と制御のマルチタスク学習. <br>
  ...
  - 宮田莉奈, 惟高日向, 山内洋輝, 柳本大輝, 梶原智之, 二宮崇, 西脇靖紘.
    MATCHA：専門家が平易化した記事を用いたやさしい日本語パラレルコーパス.<br>
    言語処理学会第31回年次大会 (NLP). March 2025.
